...
public class PatientService {
	...
	public void save(Patient patient) {
		...
		Assert.isTrue(patient.getCreditCard().getExpirationYear() >= currentMoment
				.getYear());
		if (patient.getCreditCard().getExpirationYear() == currentMoment
				.getYear()) {
			Assert.isTrue(patient.getCreditCard().getExpirationMonth() >= currentMoment
					.getMonth());
		}
	...
	public Patient reconstruct(PatientForm patientForm) {
		...
		Assert.isTrue(patientForm.getPassword().equals(
				patientForm.getSecondPassword()));
