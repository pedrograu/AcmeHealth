...
<jstl:if test="${detailsProfile==true}">
	...
	<security:authorize access="hasRole('PATIENT')">
		<jstl:if test="${isGP==true}">
			<a href="profile/patient/change.do?specialistId=${specialist.id}"><spring:message
					code="profile.change.specialist" /></a>
		</jstl:if>
	</security:authorize>
	...
	<ul>
		<li><b><spring:message code="profile.specialty.name" /></b> <jstl:out
				value="${specialist.specialty.name}"></jstl:out></li>
