...
<jstl:if test="${detailsProfile==true}">
  ...
  <div class="row">
   <div class="col-lg-4 col-md-4 col-sm-4 mb">
    <div class="panel panel-default">
     ...
     <div class="panel-body">
      <ul>
       <li><b><spring:message code="profile.datosPersonales.name" /></b> <jstl:out value="${specialist.name}"></jstl:out></li>
       <li><b><spring:message code="profile.datosPersonales.surname" /></b> <jstl:out
         value="${specialist.surname}"></jstl:out></li>
       <li><b><spring:message code="profile.datosPersonales.emailAddress" /></b> <jstl:out
         value="${specialist.emailAddress}"></jstl:out></li>
       <li><b><spring:message code="profile.datosPersonales.text" /></b> <jstl:out value="${profile.text}"></jstl:out></li>
   ...
   <div class="col-lg-4 col-md-4 col-sm-4 mb">
    <div class="panel panel-default">
     ...
     <div class="panel-body">
      <ul>
       <li><b><spring:message code="profile.specialty.name" /></b> <jstl:out value="${specialist.specialty.name}"></jstl:out></li>
       <li><b><spring:message code="profile.specialty.description" /></b> <jstl:out
   ...
   <div class="col-lg-4 col-md-4 col-sm-4 mb">
    <div class="panel panel-default">
     ...
     <div class="panel-body">
      <ul>
       <li><b><spring:message code="profile.rating2" /></b> <jstl:if test="${specialist.profile.rating!=null}">
 ...
 <div class="table-responsive">
  <display:table name="comments" id="row" requestURI="${requestURI}" pagesize="5" class="table table-hover"
   keepStatus="true">
   ...
   <display:column property="creationMoment" title="${creationMoment}" sortable="${true}"
 ...
 <security:authorize access="hasRole('PATIENT')">
  <jstl:if test="${hasAppointmentFinish==true}">
   <a href="comment/patient/create.do?profileId=${specialist.profile.id}"><spring:message
 ...
 <security:authorize access="hasRole('SPECIALIST')">
  ...
  <a href="profile/specialist/edit.do?profileId=${specialist.profile.id}"><spring:message
