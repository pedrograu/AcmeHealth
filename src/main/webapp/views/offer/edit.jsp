...
<form:form action="${requestURI}" modelAttribute="offer">
	...
	<acme:select items="${specialists}" itemLabel="name" code="offer.specialist" path="specialist"/>
	...
	<jstl:if test="${detailsOffer==true}">
	   ...
	   <ul>
			...
			<li><b><spring:message code="offer.startMoment" /></b>
				<fmt:formatDate value="${offer.startMoment}"
				pattern="dd/MM/yyyy" /></li>
			<li><b><spring:message code="offer.finishMoment" /></b>
				<fmt:formatDate value="${offer.finishMoment}"
				pattern="dd/MM/yyyy" /></li>
			<li><b><spring:message code="offer.title" /></b>
				<jstl:out value="${offer.title}"></jstl:out></li>
			<li><b><spring:message code="offer.description" /></b>
				<jstl:out value="${offer.description}"></jstl:out></li>
			<li><b><spring:message code="offer.price" /></b>
				<jstl:out value="${offer.price}"></jstl:out></li>
			<li><b><spring:message code="offer.amountPerson" /></b>
				<jstl:out value="${offer.amountPerson}"></jstl:out></li>
