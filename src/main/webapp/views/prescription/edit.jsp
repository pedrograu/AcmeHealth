...
<ul>
	...
	<jstl:out value="${prescription.appointment.specialist.surname}, ${prescription.appointment.specialist.name} (${prescription.appointment.specialist.specialty.name})"></jstl:out></li>
